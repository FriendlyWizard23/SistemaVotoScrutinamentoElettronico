...
public class OrdinaleCandidatoController extends Controller {
	...
	public void creaSessione() {
		...
		SessioneVoto nuovaSessione = new SessioneVoto(swg.getTocreate(), "ordinalecandidato", strategia, null, 0, 0,
				false, true);
