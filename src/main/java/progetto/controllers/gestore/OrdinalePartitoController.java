...
public class OrdinalePartitoController extends Controller {
	...
	public void creaSessione() {
		...
		SessioneVoto nuovaSessione = new SessioneVoto(swg.getTocreate(), "ordinalepartito", strategia, null, 0, 0,
				false, true);
